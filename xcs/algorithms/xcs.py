...
class XCSAlgorithm(LCSAlgorithm, Generic[_Value]):
    ...
    modified to control the behavior of the algorithm:
        ...
        discount_factor (default: .71, range: [0, 1))
            ...
            prediction, error, and fitness. Larger values produce more
            far-sighted behavior; smaller values produce more hedonistic
        ...
        idealization_factor (default: 0, range: [0, 1])
            ...
            of the candidate actions in an attempt to eliminate the
    ...
    def get_rule_config(self, rule: 'XCSClassifierRule') -> dict[str, Any]:
        return rule.get_configuration()

    @property
    def action_selection_strategy(self) -> ActionSelectionStrategy:
    ...
    def get_future_expectation(self, match_set: MatchSet) -> float:
    ...
    def covering_is_required(self, match_set: MatchSet) -> bool:
    ...
    def cover(self, match_set: MatchSet) -> ClassifierRule:
    ...
    def distribute_payoff(self, match_set: MatchSet) -> None:
    ...
    def update(self, match_set: MatchSet) -> None:
        ...
        assert isinstance(parent1, XCSClassifierRule)
        assert isinstance(parent2, XCSClassifierRule)
    ...
    def prune(self, model: ClassifierSet) -> list[ClassifierRule]:
    ...
    def _update_fitness(self, action_set: ActionSet) -> None:
    ...
    @staticmethod
    def _get_average_time_stamp(action_set: ActionSet) -> float:
    ...
    @staticmethod
    def _set_timestamps(action_set: ActionSet) -> None:
    ...
    @staticmethod
    def _select_parent(action_set: ActionSet) -> ClassifierRule:
    ...
    #         rules.append(dict(meta_data=meta_data, condition=condition, action=rule.action,
    #                           time_stamp=rule.time_stamp))
